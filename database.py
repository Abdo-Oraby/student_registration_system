...
COLLEGES = [
    "كلية الطب البشري", "كلية طب الأسنان", "كلية الصيدلة",
    "كلية التمريض", "كلية العلاج الطبيعي", "كلية الهندسة",
    "كلية العلوم", "كلية الحاسبات والمعلومات", "كلية الآداب",
    "كلية التربية", "كلية الحقوق", "كلية التجارة",
    "كلية الزراعة", "كلية البيطرة", "كلية الفنون الجميلة",
    "كلية التربية الرياضية", "كلية الخدمة الاجتماعية",
